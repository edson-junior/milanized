    ...
    <>
      {success && (
        <div
          role="alert"
          aria-atomic="true"
          className="flex gap-2 py-4 px-4 mb-4 font-semibold rounded border-green-500 border-2 bg-green-300 text-green-800"
        >
      ...
      {errorType === 'captcha' && (
        <div
          role="alert"
          aria-atomic="true"
          className="flex gap-2 py-4 px-4 mb-4 font-semibold rounded border-red-500 border-2 bg-red-100 text-red-800"
        >
